...
for string in strings:
	parsed_string = ast.parse(string).body[0].value.s
	total_string_characters += len(parsed_string)
	total_code_characters += len(string)

print(f"{total_code_characters=}")
print(f"{total_string_characters=}")
print("The difference between the code and the strings is:", total_code_characters - total_string_characters)
...
total_code_characters = 0
total_encoded_string_characters = 0

for string in strings:
	total_code_characters += len(string)
	total_encoded_string_characters += len(json.dumps(string))

print(f"{total_code_characters=}")
print(f"{total_encoded_string_characters=}")
print(
		"The difference between the code and the strings is:",
		total_encoded_string_characters - total_code_characters
		)
