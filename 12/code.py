...
document = PathPlus("input.txt").load_json()
...
print("The total of all numbers in the document is:", visitor.total)  # 191164
...
visitor = AbacusVisitorv2()
visitor.visit(document)
print("The total of all numbers in the document is:", visitor.total)  # 87842
